    ...
    <>
      <footer className="relative z-10 py-12 px-6 bg-slate-800 text-white">
        <div className="mx-auto max-w-5xl flex flex-wrap gap-4">
          ...
          <div className="flex-1">
            <h6 className="text-center bg-slate-600 p-1">Här finns vi</h6>
            <ol className="border-separate border-spacing-2 w-full pt-2">
              <li>Borås</li>
              <li>Växjö</li>
              <li>Stockholm</li>
            </ol>
          ...
          <div className="flex-1 basis-40">
            <p>
              ...
              labore atque libero dolorem deserunt molestias quidem maiores
              ratione. Cumque officia magni aut dolorum ad eos enim aspernatur,
              pariatur ipsa atque!
            </p>
          </div>
        </div>
